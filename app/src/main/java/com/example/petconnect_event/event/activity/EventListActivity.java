...
import com.example.petconnect_event.event.adapter.EventCardModernAdapter;
...
import com.example.petconnect_event.event.util.AnimationManager;
import com.example.petconnect_event.event.util.FavoritesManager;
import com.example.petconnect_event.event.util.HapticFeedbackManager;
