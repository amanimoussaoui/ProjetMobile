...
public class EventAdapter extends RecyclerView.Adapter<EventViewHolder> {
    ...
    private final com.example.petconnect.modules.event.util.FavoritesManager favoritesManager;
    ...
    public EventAdapter(List<Event> events, OnEventActionListener listener, com.example.petconnect.modules.event.util.FavoritesManager favoritesManager) {
        this.events = events;
