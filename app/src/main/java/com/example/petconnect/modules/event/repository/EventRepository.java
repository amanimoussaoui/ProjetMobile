...
public class EventRepository {
    ...
    // Inscription avec quota (transaction): vérifie le quota, incrémente et crée l'inscription
    public Task<Void> registerWithQuota(EventRegistration registration) {
        ...
        return db.runTransaction((Transaction.Function<Void>) transaction -> {
            ...
            if (regSnap.exists()) {
                // Déjà inscrit, ne pas doubler ni incrementer
                return null;
            }
    ...
    // Désinscription avec quota (transaction): décrémente et supprime l'inscription
