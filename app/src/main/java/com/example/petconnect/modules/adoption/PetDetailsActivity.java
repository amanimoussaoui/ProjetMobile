package com.example.petconnect.modules.adoption;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (pet == null) {
                ...
                Toast.makeText(this, "Erreur: Animal non trouvé", Toast.LENGTH_SHORT).show();
                finish();
                return;
            }
            ...
            // Initialize views - avec vérifications de nullité
            ...
            if (petPhoto == null || petName == null || adoptButton == null) {
                Log.e(TAG, "❌ Layout views are null - layout file mismatch");
                Toast.makeText(this, "Erreur de chargement UI", Toast.LENGTH_SHORT).show();
                finish();
                return;
            }
            ...
            adoptButton.setOnClickListener(v -> {
                try {
                    ...
                    Log.e(TAG, "Error starting AdoptionFormActivity", e);
                    Toast.makeText(this, "Erreur: Impossible d'ouvrir le formulaire", Toast.LENGTH_SHORT).show();
                    v.setEnabled(true);
                }
            });
        } catch (Exception e) {
            Log.e(TAG, "Fatal error in onCreate", e);
            Toast.makeText(this, "Erreur fatale: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            finish();
        }
    }
