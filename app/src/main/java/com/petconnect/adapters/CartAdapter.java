...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Holder> {
    ...
    // Interface pour les interactions avec les items
    ...
    // Constructeur principal avec listener
    ...
    public void onBindViewHolder(Holder h, int position) {
        ...
        // Bouton modifier (ouvre un dialogue pour modifier la quantité)
    ...
    private void showEditQuantityDialog(Context context, CartService.CartItem item, int position) {
        ...
        // Créer un EditText pour la quantité
