...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PostViewHolder holder, int position) {
        ...
        // --- Likes Logic ---
        // Display count based on the likedUserIds array size
        holder.btnLike.setText(String.valueOf(post.getLikeCount()));

        // Highlight icon if the current user ID exists in the likedUserIds array
        ...
        // --- Comments Logic ---
        // Dynamically calculate count from the comments list stored in the Post document
        ...
        // --- Delete Logic (Author/Admin Check) ---
        // Logic: Show the delete button ONLY if the current user is an admin
        // OR if the current user's ID matches the post author's ID.
